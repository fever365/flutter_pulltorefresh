...
void main() {
  ...
  group("trigger refresh function test", () {
    ...
    testWidgets(
      ...
      await tester.fling(find.byType(Scrollable), const Offset(0, 500.0), 5000,
          warnIfMissed: false);
    ...
    testWidgets(
      ...
      await tester.pump(const Duration(seconds: 1));
      expect(_refreshController.headerStatus, RefreshStatus.refreshing);
      await tester.drag(find.byType(Scrollable), Offset(0, -90.0),
          touchSlopY: 0.0, warnIfMissed: false);
  ...
  testWidgets("without refresh function ,only twoLevel", (tester) async {
    ...
    await tester.pump(const Duration(milliseconds: 100));
    await tester.pump(const Duration(seconds: 1));
    await tester.pump(const Duration(seconds: 1)); // more wait
