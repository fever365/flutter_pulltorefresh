...
void main() {
  testWidgets("test child attribute ", (tester) async {
    ...
    await tester.drag(find.byType(Scrollable), const Offset(0.0, -500.0), touchSlopY: 0.0);
  ...
  testWidgets("param check ", (tester) async {
    ...
    RenderViewport viewport = tester.renderObject(find.descendant(of: find.byType(Scrollable), matching: find.byType(Viewport)));
    ...
    viewport = tester.renderObject(find.descendant(of: find.byType(Scrollable), matching: find.byType(Viewport)));
    ...
    await tester.drag(find.byType(Scrollable), Offset(0, 500.0),
        touchSlopY: 0.0);
    await tester.pump();
    ...
    await tester.drag(find.byType(Scrollable), Offset(0, -4000.0),
        touchSlopY: 0.0);
    await tester.pump();
    await tester.pump(Duration(milliseconds: 100)); //canLoading
    await tester.pump(Duration(milliseconds: 100));
    expect(logs.length, 1);
  ...
  testWidgets(" verity smartRefresher and NestedScrollView", (tester) async {
    ...
    // test pull down
    await tester.drag(find.byType(Scrollable), const Offset(0, 500), touchSlopY: 0.0);
    await tester.pump();
